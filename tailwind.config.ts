  ...
  theme: {
    extend: {
      colors: {
        ...
        // Cores específicas para contexto médico
        medical: {
          success: {
      ...
      boxShadow: {
        ...
        'large': '0 10px 50px -12px rgba(0, 0, 0, 0.15), 0 20px 40px -8px rgba(0, 0, 0, 0.08)',
        'medical': '0 4px 20px -2px rgba(14, 165, 233, 0.15), 0 8px 25px -5px rgba(14, 165, 233, 0.1)',
        'success': '0 4px 20px -2px rgba(34, 197, 94, 0.15), 0 8px 25px -5px rgba(34, 197, 94, 0.1)',
        'warning': '0 4px 20px -2px rgba(245, 158, 11, 0.15), 0 8px 25px -5px rgba(245, 158, 11, 0.1)',
        'danger': '0 4px 20px -2px rgba(239, 68, 68, 0.15), 0 8px 25px -5px rgba(239, 68, 68, 0.1)',
      ...
      backgroundImage: {
        'gradient-medical': 'linear-gradient(135deg, #0ea5e9 0%, #14b8a6 100%)',
